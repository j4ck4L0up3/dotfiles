...
# custom emacs startup alias
alias myemacs='emacs -q -l ~/.config/emacs/init.el'

# custom bambu-studio startup alias
alias bambu-studio='flatpak run com.bambulab.BambuStudio'
...
# Created by `pipx` on 2025-03-15 06:22:28
